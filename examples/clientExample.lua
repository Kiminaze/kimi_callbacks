...
exports["Callbacks"]:Register("CALLBACK_NAME", function(...)
	-- do something here
...
local data1, data2, data3 = exports["Callbacks"]:Trigger("CALLBACK_NAME", ...)
...
--   "..." can be any amount of values to send to the server.
--   Returns any amount of values from the server.
local data1, data2, data3 = exports["Callbacks"]:TriggerWithTimeout("CALLBACK_NAME", timeout ...)
...
exports["Callbacks"]:Register("getPlayerPosition", function()
	local position = GetEntityCoords(PlayerPedId())

	return position
end)
--   Return player position and heading to server.
exports["Callbacks"]:Register("getPlayerPositionAndHeading", function()
...
exports["Callbacks"]:Register("getPlayerDistanceToPosition", function(position)
	local playerPos = GetEntityCoords(PlayerPedId())
...
function GetMoney()
    local cash, bank = exports["Callbacks"]:Trigger("getMoney")
...
function GetCashMoneyTimeout()
    local cashMoney = exports["Callbacks"]:TriggerWithTimeout("getMoney", 500, "cash")
